...
export default Styles = StyleSheet.create({
  ...
  userImageContainer: {
    height: windowHeight <= 600 ? 80 : 130,
    borderRadius: 130 / 2,
    width: windowHeight <= 600 ? 80 : 130,
    backgroundColor: 'transparent',
    borderWidth: 5,
    borderColor: 'white',
  },
  userImageStyles: {
    height: windowHeight <= 600 ? 70 : 120,
    width: windowHeight <= 600 ? 70 : 120,
    borderRadius: windowHeight <= 600 ? 70 / 2 : 120 / 2,
  },
